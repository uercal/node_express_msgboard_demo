...
EventUtil.addLoadHandler(function ()
{
	...
	function fnSend ()
	{
		...
		{
			var head_pic = $('#face .current').attr('src');
			head_pic = head_pic.substring(-22);
			//调用ajax
			var username = $('#userName').val();
			var content = $('#conBox').val();
			$.get("/add",{username:username,content:content,head_pic:head_pic},function(data){
				console.log(data);				
			});
